...
sidebarTitle: "Send a bank payment"
...
The limits and the fee are enforced server-side, on the route itself. The 402 challenge's `amount` is the authoritative total and already includes the fee.
