...
<Steps>
  ...
  <Step title="Card is issued">
    The server verifies payment and returns a `card_id` with
    `status: "pending"`. It does not return the card number, CVV, or expiry.
    Those become available in ~7-10 seconds.
  </Step>
