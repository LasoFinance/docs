...
- **Issuer terms:** Placing the order accepts the card issuer's [Cardholder Agreement](https://laso.finance/intl-card-cardholder-agreement.pdf), [E-Communications Disclosure](https://laso.finance/intl-card-e-communications-disclosure.pdf), and [Privacy Notice](https://laso.finance/intl-card-privacy-notice.pdf) on behalf of the account holder.
