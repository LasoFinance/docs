...
```json
{
  ...
  "hint": "This limit is per card: at most one refresh every 5 minutes, and 24 in any rolling 24-hour period. Wait retry_after_seconds and try again, or read the cached balance with GET /get-card-data in the meantime."
}
```
