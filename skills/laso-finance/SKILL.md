...
_Docs version `159542b40118`. This is a content hash of the Laso Finance agent docs. If it differs from the live version at https://laso.finance/.well-known/docs-version.json, your cached copy is stale. Refetch to get the current docs._
...
If all three hold, the decline is merchant-side. Some merchants reject prepaid or debit cards, and some non-U.S. merchants decline U.S.-issued cards. Try a different merchant or ask the account holder.
