---
title: 'Local development with the Mintlify CLI'
description: 'Install the Mintlify CLI, preview documentation changes locally, troubleshoot common setup issues, and keep your docs site fast during development.'
---
