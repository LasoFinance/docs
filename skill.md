...
_Docs version `1556de4e41da`. This is a content hash of the Laso Finance agent docs. If it differs from the live version at https://laso.finance/.well-known/docs-version.json, your cached copy is stale. Refetch to get the current docs._
...
- **You have a shell, Python 3, and outbound HTTPS:** use the setup helper below.
  ...
  it every session.
- **You already pay from your own wallet:** use
...
API base: `https://laso.finance`. Managed-wallet callables:
`https://us-central1-kyc-ts.cloudfunctions.net/<name>`.
...
| Authenticate with your own wallet, use Locus, sign x402 payments                             | [Wallet-native](https://laso.finance/skills/laso-finance/references/wallet-native.md) |
