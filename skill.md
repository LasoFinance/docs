...
Buy things (paywalled, priced in USDC):
  ...
  GET  /order-intl-card?amount=             $100-$1,000   Intl card, +3.8%, queued for fulfillment
...
We also publish a discovery index at https://laso.finance/.well-known/agent-skills/index.json if your framework consumes one.
