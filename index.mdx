...
<Columns cols={2}>
  ...
  >
    Let Laso hold the key and settle x402 payments, on our endpoints or any
    third-party service, capped per call and pinned to the asset, network, and
    recipient you expect.
  </Card>
  <Card
    title="API Reference"
    icon="terminal"
