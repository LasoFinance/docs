---
title: 'Configure navigation groups and tabs in docs.json'
description: 'Define tabs, groups, and nested page lists in the docs.json navigation field so readers can find Mintlify documentation pages quickly.'
icon: 'map'
---
