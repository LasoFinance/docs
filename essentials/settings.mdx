---
title: 'Global settings reference for the docs.json file'
description: 'Reference for Mintlify global settings in docs.json, including theme colors, logos, navbar, footer, analytics, and integrations for your docs site.'
icon: 'gear'
---
