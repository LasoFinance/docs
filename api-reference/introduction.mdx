...
| `/send-bank-payment`     | GET    | Dynamic (\$10-\$10,000 + 0.25% fee, min \$1.50) | Send dollars to a bank account by ACH. Needs a `destination_id` registered on an approved banking profile first.                    |
