...
| `/feedback`              | POST   | Free (Bearer token)                         | Send feedback about the API to the humans running Laso. Served from the Cloud Function URL, not `laso.finance`. Requires a completed real action; limited to 5/24h. |
