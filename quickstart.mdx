---
title: "Mintlify starter template quickstart"
description: "Clone your Mintlify docs repository, install the CLI, preview changes locally, and publish your first update to production in just a few minutes."
---
